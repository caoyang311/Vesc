 ...
 *
 *         void CircleLimit(int16 u1, int16 u2, int16 y1[1], int16 y2[1])
 *
 *    Simulink version           : 10.4 (R2021b) 14-May-2021
 *    C source code generated on : 03-Mar-2024 15:41:15
 *
...
#define S_FUNCTION_NAME  sfun_CircleLimit
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "CircleLimit", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    } /* if */
