/**
 * sfun_GetBuffAvgVal.c
 *
 *    ABSTRACT:
 *      The purpose of this sfunction is to call a simple legacy
 *      function during simulation:
 *
 *         int32 y1 = GetBuffAvgVal(int32 u1)
 *
 *    Simulink version           : 10.4 (R2021b) 14-May-2021
 *    C source code generated on : 29-Feb-2024 20:23:38
 *
...
#define S_FUNCTION_NAME  sfun_GetBuffAvgVal
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "GetBuffAvgVal", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    } /* if */
